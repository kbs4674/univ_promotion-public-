class CreateUnivs < ActiveRecord::Migration[5.1]
  def change
    create_table :univs do |t|
      ...
      t.boolean :dbpia # 논문 열람사이트, 보통 학교 도서관 사이트를 경유해서 무료로 논문열람 가능 [http://www.dbpia.co.kr/]
      t.boolean :dcollection # 논문 열람사이트, 보통 학교 도서관 사이트를 경유해서 무료로 논문열람 가능 [http://www.dcollection.net/]
      t.boolean :riss # 논문 열람사이트, 보통 학교 도서관 사이트를 경유해서 무료로 논문열람 가능 [www.riss.kr]
      t.boolean :aws_credit_100 # AWS 협약대학 100달러 Credit 제공 [https://aws.amazon.com/ko/education/awseducate/]
