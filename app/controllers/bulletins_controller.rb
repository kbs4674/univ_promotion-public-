class BulletinsController < ApplicationController
  ...
  private
    ...
    def bulletin_params
      ...
      params.require(:bulletin).permit(:title, :content, :user_id, :user_nickname, :opt_admin_only, :opt_email, :opt_email_quantity, :opt_card_bulletin, :opt_hashtag, :opt_post_vote, :opt_comment_vote)
    end
end
